...
export function presaleUI(){
  const min={ETH:0.05,USDC:200,USDT:200,BNB:0.3,SOL:1}, rate={ETH:585000,USDC:125,USDT:125,BNB:130000,SOL:27000};
  ...
  const raised=14693879, goal=20000000, pct=Math.min(100,(raised/goal)*100);
