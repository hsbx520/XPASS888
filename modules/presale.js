...
export function presaleUI(){
  const min={ETH:0.05,USDC:200,USDT:200,BNB:0.3,SOL:1}, rate={ETH:565000,USDC:125,USDT:125,BNB:112500,SOL:27000};
  ...
  const raised=10243962, goal=10500000, pct=Math.min(100,(raised/goal)*100);
...
function openConfirm(val,token){
  ...
  const rateMap = { ETH:565000, USDC:125, USDT:125, BNB:112500, SOL:27000 };
  ...
  howDlg.innerHTML = `
    ...
    <div class="ts-card">
      ...
      <ul>
        ...
        <li>1 BNB = 112,500 XPASS (Min: 0.3 BNB)</li>
