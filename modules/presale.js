...
export function presaleUI(){
  const min={ETH:0.05,USDC:200,USDT:200,BNB:0.3,SOL:1}, rate={ETH:585000,USDC:125,USDT:125,BNB:115000,SOL:27000};
  ...
  const raised=12072496, goal=12500000, pct=Math.min(100,(raised/goal)*100);
